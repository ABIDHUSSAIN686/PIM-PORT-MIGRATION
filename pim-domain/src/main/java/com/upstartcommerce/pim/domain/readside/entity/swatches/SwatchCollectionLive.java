...
import com.upstartcommerce.pim.domain.readside.entity.key.SwatchCollectionLiveKey;
import lombok.Data;
...
@Table("swatch_collection_live")
@Data
@EqualsAndHashCode(callSuper = false)
public class SwatchCollectionLive {

    @PrimaryKey
    private SwatchCollectionLiveKey key;
