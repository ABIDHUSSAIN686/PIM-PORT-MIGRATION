...
import com.upstartcommerce.pim.domain.readside.entity.key.SwatchCollectionTypeLiveByIdKey;
import lombok.Data;
...
@Table("swatch_collection_type_live_by_id")
@Data
@EqualsAndHashCode(callSuper = false)
public class SwatchCollectionTypeLiveById {

    @PrimaryKey
    private SwatchCollectionTypeLiveByIdKey key;
