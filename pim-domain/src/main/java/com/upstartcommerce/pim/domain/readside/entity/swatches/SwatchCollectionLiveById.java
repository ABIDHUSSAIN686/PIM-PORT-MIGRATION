...
import com.upstartcommerce.pim.domain.readside.entity.key.SwatchCollectionLiveByIdKey;
import lombok.Data;
...
@Table("swatch_collection_live_by_id")
@Data
@EqualsAndHashCode(callSuper = false)
public class SwatchCollectionLiveById {

    @PrimaryKey
    private SwatchCollectionLiveByIdKey key;
