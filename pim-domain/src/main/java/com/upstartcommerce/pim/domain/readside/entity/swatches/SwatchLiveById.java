...
import com.upstartcommerce.pim.domain.readside.entity.key.SwatchLiveByIdKey;
import lombok.Data;
...
@Table("swatch_live_by_id")
@Data
@EqualsAndHashCode(callSuper = false)
public class SwatchLiveById {

  @PrimaryKey
  private SwatchLiveByIdKey key;
