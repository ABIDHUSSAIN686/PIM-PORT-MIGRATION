...
import com.upstartcommerce.pim.domain.readside.entity.key.SwatchCollectionByIdKey;
import lombok.Data;
...
@Table("swatch_collection_by_id")
@Data
@EqualsAndHashCode(callSuper = false)
public class SwatchCollectionById {

    @PrimaryKey
    private SwatchCollectionByIdKey key;
